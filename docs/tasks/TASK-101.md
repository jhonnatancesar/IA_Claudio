# TASK-101 — Criar frontend web do chat

Status: Pendente

## Objetivo

Criar frontend web do chat, conforme a especificação mestre (`Claudiao_Especificacao_Arquitetura_e_TASKs.docx`, bloco "Chat web") e `docs/ARCHITECTURE.md`.

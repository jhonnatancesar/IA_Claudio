# TASK-122 — Implementar logout por inatividade

Status: Pendente

## Objetivo

Implementar logout por inatividade, conforme a especificação mestre (`Claudiao_Especificacao_Arquitetura_e_TASKs.docx`, bloco "Administração") e `docs/PANEL.md`.

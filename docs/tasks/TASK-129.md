# TASK-129 — Implementar restore

Status: Pendente

## Objetivo

Implementar restore, conforme a especificação mestre (`Claudiao_Especificacao_Arquitetura_e_TASKs.docx`, bloco "Operação") e `docs/BACKUP_RESTORE.md`.

# TASK-108 — Criar sistema de cotas

Status: Pendente

## Objetivo

Criar sistema de cotas, conforme a especificação mestre (`Claudiao_Especificacao_Arquitetura_e_TASKs.docx`, bloco "Cotas") e `docs/QUOTAS.md`.

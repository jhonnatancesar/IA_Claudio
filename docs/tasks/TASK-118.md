# TASK-118 — Gestão de providers

Status: Pendente

## Objetivo

Gestão de providers, conforme a especificação mestre (`Claudiao_Especificacao_Arquitetura_e_TASKs.docx`, bloco "Administração") e `docs/PANEL.md`.

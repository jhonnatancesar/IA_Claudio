# TASK-113 — Implementar alertas 80/95%

Status: Pendente

## Objetivo

Implementar alertas 80/95%, conforme a especificação mestre (`Claudiao_Especificacao_Arquitetura_e_TASKs.docx`, bloco "Cotas") e `docs/QUOTAS.md`.

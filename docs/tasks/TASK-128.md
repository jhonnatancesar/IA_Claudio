# TASK-128 — Implementar verificação de integridade

Status: Pendente

## Objetivo

Implementar verificação de integridade, conforme a especificação mestre (`Claudiao_Especificacao_Arquitetura_e_TASKs.docx`, bloco "Operação") e `docs/BACKUP_RESTORE.md`.

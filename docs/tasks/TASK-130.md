# TASK-130 — Implementar backup pré-restore

Status: Pendente

## Objetivo

Implementar backup pré-restore, conforme a especificação mestre (`Claudiao_Especificacao_Arquitetura_e_TASKs.docx`, bloco "Operação") e `docs/BACKUP_RESTORE.md`.

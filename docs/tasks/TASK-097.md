# TASK-097 — Implementar chamadas a outros agentes

Status: Pendente

## Objetivo

Implementar chamadas a outros agentes, conforme a especificação mestre (`Claudiao_Especificacao_Arquitetura_e_TASKs.docx`, bloco "APIs e arquivos") e `docs/TOOLS.md`.

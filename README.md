...
**TASK-001** a **TASK-018** concluídas — blocos "Fundação" e "Segurança e
identidade" completos; `LocalLLMProvider`, `OllamaProvider`, o protocolo JSON
modelo ↔ orquestrador, sua validação semântica e o prompt-base funcionando.
...
([docs/tasks/TASK-019.md](docs/tasks/TASK-019.md)).

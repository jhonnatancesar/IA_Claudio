...
**TASK-001** a **TASK-050** concluídas — blocos "Fundação", "Segurança e
...
separação por usuário/aplicação, Memory Tool, busca estruturada,
relevância/frequência/last used, política de retenção, limite fixo). Ver
...
([docs/tasks/TASK-051.md](docs/tasks/TASK-051.md)).

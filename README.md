...
**TASK-001** a **TASK-071** concluídas — blocos "Fundação", "Segurança e
...
timeout aplicado de fato e com formato de erro específico).
Ver
...
([docs/tasks/TASK-072.md](docs/tasks/TASK-072.md)).

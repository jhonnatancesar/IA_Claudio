...
**TASK-001** a **TASK-081** concluídas — blocos "Fundação", "Segurança e
...
orquestrador, métricas básicas, painel web read-only mostrando a fila —
execuções/erros/logs/consumo no painel ainda pendentes).
Ver
...
([docs/tasks/TASK-082.md](docs/tasks/TASK-082.md)).

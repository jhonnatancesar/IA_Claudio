...
**TASK-001** a **TASK-065** concluídas — blocos "Fundação", "Segurança e
...
LOW/MEDIUM/HIGH, atualização e histórico de reputação, blacklist,
bloqueio automático). Ver
...
([docs/tasks/TASK-066.md](docs/tasks/TASK-066.md)).

...
def replan(
    ...
    estiver em estado terminal — não há plano "restante" para descartar
    numa execução que já acabou.
    """
    ...
    step = plan_initial_step(orchestrator, new_execution, objective, model)

...
- `memory_model.py` (TASK-044, TASK-045) — `Memory` (dataclass),
  ...
  nunca mistura memórias de outro dono. Memory Tool (TASK-046), busca
  estruturada (TASK-047), relevância/frequência/last_used (TASK-048),

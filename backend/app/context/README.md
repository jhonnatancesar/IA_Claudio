...
- `context_manager.py` (TASK-037 a TASK-040) — `ContextManager`
  ...
  usuário em `corrections`, em ordem cronológica. Detectar troca de assunto
  real (TASK-041) e monitor de janela de contexto (TASK-042/TASK-043) não
  são desta TASK.
